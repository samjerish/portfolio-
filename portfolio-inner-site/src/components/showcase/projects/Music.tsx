...
import houseProject from '../../../assets/images/projects/audio/houseProject.png';
import dnbDrumsProject from '../../../assets/images/projects/audio/dnbDrumsProject.png';
    ...
    return (
        <div className="site-page-content">
            ...
            <MusicPlayer
                src={dnb}
                title="Break [Demo]"
                subtitle="SAM JERISH D - 2019/2026"
                currentSong={currentSong}
                setCurrentSong={setCurrentSong}
            />
            <br />
